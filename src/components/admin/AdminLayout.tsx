      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 fixed top-0 left-0 right-0 z-50">
        <div className="flex items-center justify-between px-3 sm:px-4 h-14 sm:h-16">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <h1 className="text-base sm:text-xl text-gray-900 dark:text-white font-serif truncate">
              The Chronicle
            </h1>
            <span className="hidden sm:inline px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded text-xs">
              Admin
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            ...
            <Button
              ...
              onClick={onLogout}
              size="sm"
              className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 px-2 sm:px-4"
            >
        ...
        >
          <nav className="p-3 sm:p-4 space-y-2">
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
              <button className="w-full flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-sm sm:text-base">
